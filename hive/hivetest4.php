<?php
// DIAGNOSTIC ONLY — logs fatal error details to a PRIVATE server-side file (never echoed to the HTTP response, never publicly reachable via URL)
register_shutdown_function(function(){
  ...
  if ($e && in_array($e['type'], [E_ERROR, E_PARSE, E_CORE_ERROR, E_COMPILE_ERROR, E_USER_ERROR, E_RECOVERABLE_ERROR])){
    ...
    @file_put_contents(sys_get_temp_dir() . '/hive_diag_error.json', json_encode($safe));
  }
});
/* ============================================================
