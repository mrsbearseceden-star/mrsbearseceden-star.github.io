...
$PERMS = [
  'teacher' => ['read' => ['Lesson Plan Index','Resource Links','Facility Checklists','Buzz Board'], 'create'=>['Teacher Questions'], 'update'=>['Facility Checklists' => ['Checked','Checked By','Time','Notes','Status','Room / Classroom']]],
  'parent' => $PARENT_PERMS,
